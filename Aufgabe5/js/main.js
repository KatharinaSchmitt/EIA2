...
(function (Aufgabe5) {
    ...
    function init(_event) {
        produktarrayDarstellen(Aufgabe5.data);
    ...
    function einzelproduktDarstellen(_produkt) {
        ...
        input.setAttribute("anzahlmin", _produkt.anzahlmin.toString());
        input.setAttribute("anzahlmax", _produkt.anzahlmax.toString());
